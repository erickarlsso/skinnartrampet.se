...
DEVSITE="http://skinnartrampet.test"

PRODDIR="web@skinnartrampet.se:/srv/www/skinnartrampet.se/shared/uploads/"
PRODSITE="https://skinnartrampet.se"

STAGDIR="web@staging.skinnartrampet.se:/srv/www/skinnartrampet.se/shared/uploads/"
STAGSITE="https://staging.skinnartrampet.se"
